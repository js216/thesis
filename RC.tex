...
Fig.~\fref{AR_win_p1}. We see that unless the window thickness is matched to the
...
as built (Fig.~\fref{RCch}) has three pairs of identical microwave windows. The
...
all the laser and microwave beams. With these dimensions, the clipping of
...
which is more than the $\approx2$\%\ shown in the plot in Fig.~\fref{wires}. It
...
because the microwaves were transmitted out through the laser windows of one
...
Here we have worked through an estimate of the required microwave power to
enable to rotational cooling of thallium fluoride molecules. We have considered
the effect of these microwave beams as they reflect off windows and the vacuum
chamber walls, and how the reflected stray beams may be blocked off from
entering the other modules of the \CENTREX\ experiment.

\keypoint{Why is it important for CeNTREX?}

It is important to minimize the stray reflections of microwave beams to avoid
inadvertently driving microwave transitions in other parts of the experiment,
causing unexpected backgrounds or systematic shifts.

\keypoint{Will we revisit it in later sections?}

No. The following chapters are primarily concerned with the control of static or
near-static electric and magnetic fields.

\keypoint{What are the biggest remaining challenges to getting a measurement?}

The work presented in this chapter has been done at a very early stage in the
development of the rotational cooling chamber. However, as reported in our
overview paper \cite{grasdijk2021centrex}, we believe to have solved the
remaining challenges in making the rotational cooling module operational.
