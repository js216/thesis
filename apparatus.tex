...
separated by exactly 2~cm and held in place using a series of MACOR rings and
rods. The vacuum chamber is enclosed in the magnetic field control system (see
section \ref{mfc_chapter}), consisting of the magnetic shield and the shim
coils.
