...
obtained data to the local disks (see Fig.~\ref{DAQ_flow}). In the future, we
...
Fig.~\ref{transverse_rail}, are 4' long. Given the size of the mounting
...
See Fig.~\ref{lasers} for a diagram of the tunable \UV\ laser system. It
