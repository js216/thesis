...
arranged in a quadrupole configuration. The rods are manufactured out of
316-alloy stainless steel with circular cross-section and rounded ends to avoid
high electric field concentration that would result in sparking. The support
rods holding the electrodes are machined out of MACOR ceramic. The
electrodes--rod assembly is held in place by two stainless rings. The pair of
electrodes diagonally opposite each other have the same voltage of magnitude
30~kV; the two pairs have opposite polarity. The vacuum chamber is a 16" OD,
24.6" long cylinder made of 1/8" thick stainless steel, with ISO400F flanges at
each end and a sequence of smaller ports for electrical feedthroughs, pumps,
windows, etc.
