...
\begin{figure*}[b!]
    \begin{overpic}[width=\textwidth,unit=0.84mm]{figs/entire.pdf}
    ...
    beamline without the magnetic shield around the interaction region. Note
    that the second state-preparation region, and the detection chamber, have
    not yet been designed. The horizontal ordinate is given in meters.}
    \label{entire}
\end{figure*}
...
\begin{figure}
    ...
    pulsed Nd:YAG, provinding 4~ns pulses of maximum energy 130~mJ at max.\
...
\begin{figure*}
    ...
    second harmonic generation (\SHG). [Drawings by O. Grasdijk]}
    \label{lasers}
\end{figure*}
...
\begin{figure}
    ...
    \caption[Frequency-agile microwave generation.]{The principle behing
