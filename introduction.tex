...
The spacing between the levels can be measured by a technique based on Rabi
oscillations. Consider two states, $\ket p$ and $\ket q$, separated by an energy
$\hbar\omega_0$, and placed in an oscillating field $\hbar b e^{-i\omega\tau}$.
Defining the detuning $\delta\equiv\omega_0-\omega$, the population transfer
