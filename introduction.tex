...
\begin{table*}
    ...
    \makebox[\textwidth][c]{%
        ...
        the applied interaction-region electric and magnetic fields (and
        \emph{not} fields internal to the molecule).}
        \label{previouswork}
\end{table*}
...
oscillatory field configuration to excite the \gls{NMR} resonance. Finally, we probe
