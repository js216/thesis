...
In this section, I present a simple way to calculate the matrix elements of the
...
In addition, I define an iterator method to loop through the components, and the
...
rotational structure is not of interest, so I subtract it for clarity in the
