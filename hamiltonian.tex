...
\paragraph{Representing the states}
...
\begin{itemize}
   ...
   \item inner product, returning either 0 or 1;
   \item superposition and scalar multiplication, returning a \verb`State` object
...
\paragraph{Terms with ang. momentum dot products}
...
\paragraph{An alternative $c_3$ term}
...
\paragraph{Finding the matrix elements}
...
operator for a range of states at some given value of external fields, which is
proportional to the polarization of the molecule:
...
This produces Fig.~\ref{polarizeTlF} for the polarization of TlF as a function
