...
\paragraph{Adapting the setup for larger targets}
...
packing tape, place in a ziplock bag, wrap it with packing tape, and place in
...
\paragraph{Heater inside the vacuum}
