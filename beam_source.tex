...
The cell assembly (Fig.~\ref{cell_assembly}) is rigidly attached to the tapped holes on the cold head of
...
\begin{figure}
    ...
    well as the Back Snorkel, have been removed from the beam source.}
    \label{cell_assembly}
\end{figure}
