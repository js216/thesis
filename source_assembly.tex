...
The following steps are to be followed with the help of the pictures in the
following pages
(Figs~\ref{beam_source_assembly_1}--\ref{beam_source_assembly_7J}). The
numbering of these steps is referred to in the figure captions, which provide
more information to accompany this abbreviated summary.
...
\begin{enumerate}
   ...
   \item Attach PT warm and cold stage thermometers using brass screws and
       indium foil.
   \item Install 40K shield
      \begin{enumerate}[label=\Alph*.]
         ...
         \item Attach 40K flexible braided heat links to the PT warm stages,
             using indium foil as the interface material.
         \item Assemble 40K box with bottom plate. No interface materials or
             grease are used with the 40K box.
         \item Attach the neon heat exchanger (section \ref{cell_ass_sect},
             Fig.~\fref{neon_line}) to 40K top plate.
   ...
   \item Attach helium lines connecting the pulse tubes with the compressors, test cryogenic operation.
   \item Insert target.
\end{enumerate}
...
\begin{figure}[b]
    ...
    holes are not interchangeable, the vacuum chamber is not symmetric! The
    orient back vs.\ front, please consult Fig.~\fref{beam_source_vacuum}.}
...
\begin{figure}
    ...
    \caption{Step 2: return beam source to 80/20 frame.}
...
\begin{figure}
    ...
    \caption[Step 5A: attach PT warm-stage thermometers.]{Step 5A: attach PT
    warm-stage thermometers. CTC100 refers to the cryogenic temperature
    controller (see section \ref{beam_source_electronic}).}
